...
namespace FSi\DoctrineExtension\Tests\LoStorage;

use FSi\DoctrineExtension\Tests\LoStorage\Fixture\Article;
use FSi\DoctrineExtension\Tests\LoStorage\Fixture\News;
...
{
    const ARTICLE = "FSi\\DoctrineExtension\\Tests\\LoStorage\\Fixture\\Article";
    const NEWS = "FSi\\DoctrineExtension\\Tests\\LoStorage\\Fixture\\News";
    const PHOTO = "FSi\\DoctrineExtension\\Tests\\LoStorage\\Fixture\\Photo";

    const TEST_FILE_1 = '/FSi/DoctrineExtension/Tests/LoStorage/Fixture/favourite.gif';
    const TEST_FILE_2 = '/FSi/DoctrineExtension/Tests/LoStorage/Fixture/star.png';
    const TEST_THUMB_1 = '/FSi/DoctrineExtension/Tests/LoStorage/Fixture/lighthouse_s.jpg';
    const TEST_THUMB_2 = '/FSi/DoctrineExtension/Tests/LoStorage/Fixture/penguins_s.jpg';
    const TEST_PHOTO_1 = '/FSi/DoctrineExtension/Tests/LoStorage/Fixture/lighthouse_l.jpg';
    const TEST_PHOTO_2 = '/FSi/DoctrineExtension/Tests/LoStorage/Fixture/penguins_l.jpg';
