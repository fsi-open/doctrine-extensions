<?php
namespace FSi\DoctrineExtensions\Versionable\Query;
...
class VersionableTreeWalker extends TreeWalkerAdapter
{
    ...
    public function __construct($query, $parserResult, array $queryComponents)
    {
        ...
        if (($query->getHydrationMode() != \FSi\DoctrineExtensions\ORM\Query::HYDRATE_OBJECT) ||
            ...
            throw new Exception\RuntimeException('Using VersionableTreeWalker requires FSi\DoctrineExtensions\ORM\Hydration\ObjectHydrator to be set for the same query');
        }
