...
use FSi\DoctrineExtension\Mapping\Driver\DriverInterface;
...
final class ExtendedMetadataFactory extends MetadataFactory
{
     ...
     * @throws \FSi\DoctrineExtension\Mapping\Exception\RuntimeException if driver was not found in extension or it is not compatible
     * @return \FSi\DoctrineExtension\Mapping\Driver\DriverInterface
     */
    private function getDriver($omDriver)
    {
        ...
        if ($omDriver instanceof DriverChain || $driverName == 'DriverChain') {
            ...
            if (!($driver instanceof DriverInterface)) {
                throw new Exception\RuntimeException(sprintf("Driver of class %s does not implement required FSi\DoctrineExtension\Mapping\Driver\DriverInterface", get_class($driver)));
            }
