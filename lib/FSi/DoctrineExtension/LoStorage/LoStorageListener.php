...
namespace FSi\DoctrineExtension\LoStorage;
...
use FSi\DoctrineExtension\LoStorage\Mapping\ClassMetadata as LoStorageClassMetadata;
...
class LoStorageListener extends MappedEventSubscriber
{
     ...
     *
     * @param string $basePath
     * @return \FSi\DoctrineExtension\LoStorage\LoStorageListener
     */
...
//            'loadClassMetadata',
    ...
    public function validateExtendedMetadata(ClassMetadata $baseClassMetadata, ClassMetadataInterface $extendedClassMetadata)
    {
        if (!($extendedClassMetadata instanceof LoStorageClassMetadata)) {
            throw new Exception\MappingException('Metadata passed to LoStorage listener is not an object of class FSi\DoctrineExtension\LoStorage\Mapping\ClassMetadata');
        }
