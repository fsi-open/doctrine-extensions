...
namespace FSi\DoctrineExtension\LoStorage\Mapping\Driver;
...
use FSi\DoctrineExtension\LoStorage\Exception\AnnotationException;

class Annotation extends AbstractAnnotationDriver
{
    const TIMESTAMP = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\Timestamp';
    const FILENAME = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\Filename';
    const FILEPATH = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\Filepath';
    const MIMETYPE = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\MimeType';
    const SIZE = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\Size';
    const DATA = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\Data';
    const STORAGE = 'FSi\\DoctrineExtension\\LoStorage\\Mapping\\Annotation\\Storage';
